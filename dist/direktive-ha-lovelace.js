 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */var dt,ct,ht;function vt(t,e,i){if(e.has("config")||i)return!0;if(t.config.entity){var s=e.get("hass");return!s||s.states[t.config.entity]!==t.hass.states[t.config.entity]}return!1}null===(dt=window.HTMLSlotElement)||void 0===dt||dt.prototype.assignedElements,function(t){t.language="language",t.system="system",t.comma_decimal="comma_decimal",t.decimal_comma="decimal_comma",t.space_comma="space_comma",t.none="none"}(ct||(ct={})),function(t){t.language="language",t.system="system",t.am_pm="12",t.twenty_four="24"}(ht||(ht={}));let pt=class extends ot{setConfig(t){this._config=t}static get styles(){return r`
      ha-form {
        padding: 16px;
      }
    `}render(){return this.hass&&this._config?I`
      ...
      ></ha-form>
    `:I``}_valueChanged(t){const e=t.detail.value;e&&(this._config=e,this.dispatchEvent(new CustomEvent("config-changed",{detail:{config:e}})))}};t([at({attribute:!1})],pt.prototype,"hass",void 0),t([lt()],pt.prototype,"_config",void 0),pt=t([(t=>e=>"function"==typeof e?((t,e)=>(customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:i,elements:s}=e;return{kind:i,elements:s,finisher(e){customElements.define(t,e)}}})(t,e))("direktive-ha-lovelace-editor")],pt);class ut extends ot{constructor(){super(...arguments),this.directives=[],this.selectedDirective=null,this.conversationInput="",this.isSendingMessage=!1,this.expandedDirective=null,this.newDirectiveMessage="",this._isRendered=!1}setConfig(t,e){this.config={type:"direktive-ha-lovelace-dialog",name:"Direktive.ai Lovelace Component",entity:"sensor.direktive_sensor"},this.hass=t,this.directives=e}shouldUpdate(t){return this._hasConfigOrEntityChanged(this,t,!1)||vt(this,t,!1)}_hasConfigOrEntityChanged(t,e,i){if(e.has("config")||i)return!0;const s=e.get("hass");if(s&&this.config.entity){return s.states[this.config.entity].state!==t.hass.states[this.config.entity].state}return!1}async _createDirective(){if(this.newDirectiveMessage.trim())try{await this.hass.callWS({type:"direktive/create_directive",message:this.newDirectiveMessage.trim()}),this.newDirectiveMessage=""}catch(t){this._showNotification("Error creating directive","error")}}async _deleteDirective(t){try{await this.hass.callWS({type:"direktive/delete_directive",directive_id:t})}catch(t){console.error("Error deleting directive:",t),this._showNotification("Error deleting directive","error")}}async _downloadDirective(t){try{await this.hass.callWS({type:"direktive/download_directive",directive_id:t})}catch(t){console.error("Error downloading directive:",t),this._showNotification("Error downloading directive","error")}}_showNotification(t,e){this.hass.callService("persistent_notification","create",{title:"Direktive.ai",message:t,notification_id:`direktive_${e}`})}_getStatusIcon(t){return"creating"===t.status||"updating"===t.status||"deleting"===t.status?"mdi:loading":t.discovery?"mdi:creation-outline":"success"===t.status?"mdi:check-all":"error"===t.status?"mdi:alert-circle":"mdi:help-circle"}_getStatusClass(t){if(t.discovery)return"status-discovery";switch(t.status){case"success":return"status-success";case"error":return"status-warning";case"creating":return"status-creating";case"updating":return"status-updating";default:return"status-unknown"}}async _loadConversation(t){try{await this.hass.callWS({type:"direktive/get_conversation",directive_id:t})}catch(t){console.error("Error loading conversation:",t),this._showNotification("Error loading conversation","error")}}async _sendMessage(){if(this.selectedDirective&&this.conversationInput.trim()&&!this.isSendingMessage)try{this.isSendingMessage=!0,await this.hass.callWS({type:"direktive/send_conversation_message",directive_id:this.selectedDirective,prompt:this.conversationInput.trim()})}catch(t){console.error("Error sending message:",t),this._showNotification("Error sending message","error")}finally{this.isSendingMessage=!1,this.conversationInput=""}}static get styles(){return r`
      :host {
        display: block;
        padding: 16px;
        max-width: 600px;
    ...
    `}}t([lt()],ut.prototype,"hass",void 0),t([lt()],ut.prototype,"config",void 0),t([lt()],ut.prototype,"directives",void 0),t([lt()],ut.prototype,"selectedDirective",void 0),t([lt()],ut.prototype,"conversationInput",void 0),t([lt()],ut.prototype,"isSendingMessage",void 0),t([lt()],ut.prototype,"expandedDirective",void 0),t([lt()],ut.prototype,"newDirectiveMessage",void 0),customElements.define("direktive-ha-lovelace-dialog",ut),console.info("%c  DIREKTIVE-HA-LOVELACE \n%c  version: 2.0.2  ","color: orange; font-weight: bold; background: black","color: white; font-weight: bold; background: dimgray"),window.customCards=window.customCards||[],window.customCards.push({type:"direktive-ha-lovelace",name:"Direktive.ai Lovelace Component",description:"A custom card for managing directives"});class gt extends ot{constructor(){super(...arguments),this.directives=[],this.dialog=null}static async getConfigElement(){return document.createElement("direktive-ha-lovelace-editor")}static getStubConfig(){return{}}setConfig(t){if(!t)throw new Error("Invalid configuration");this.config=Object.assign(Object.assign({},t),{name:"Direktive.ai Lovelace Component",entity:"sensor.direktive_sensor"})}shouldUpdate(t){return!!this.config&&vt(this,t,!1)}_getStatus(){return this.directives.reduce(((t,e)=>(t[e.status]++,t.total++,t)),{total:0,success:0,error:0})}_openDialog(){this.dialog=new ut,this.dialog.setConfig(this.hass,this.directives),this.dialog.show()}static get styles(){return r`
      :host {
        --spacing: 12px;
      }
    ...
    `}_updateDirectivesFromSensor(){const t=this.hass.states[this.config.entity];console.log("sensor",t),t&&t.attributes.directives&&(this.directives=t.attributes.directives,this.dialog&&this.dialog.setConfig(this.hass,this.directives))}firstUpdated(){this._updateDirectivesFromSensor()}render(){this._updateDirectivesFromSensor();const t=this._getStatus();return I`
      <ha-card
      ...
      >
        <div class='direktive-ha-lovelace'>
          <div class="status-icon">
            ${t.error>0?I`<ha-icon icon="mdi:alert-circle" class="status-warning"></ha-icon>`:I`<ha-icon icon="mdi:alpha-d-circle"></ha-icon>`}
          </div>
          <div class="status-text">
            ...
            <div class="status-text-subtitle">
              ${t.error>0?I`<i>You have <span>${t.error}</span> errors</i>`:I`<i>You have no errors</i>`}
            </div>
          </div>
        </div>
      </ha-card>
    `}}t([lt()],gt.prototype,"hass",void 0),t([lt()],gt.prototype,"config",void 0),t([lt()],gt.prototype,"directives",void 0),customElements.define("direktive-ha-lovelace",gt);export{gt as DirektiveComponent};
