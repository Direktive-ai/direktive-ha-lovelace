...
customElements.define('action-handler-direktive-ha-lovelace', ActionHandler);

const getActionHandler = (): ActionHandler => {
  const body = document.body;
  if (body.querySelector('action-handler-direktive-ha-lovelace')) {
    return body.querySelector('action-handler-direktive-ha-lovelace') as ActionHandler;
  }

  const actionhandler = document.createElement('action-handler-direktive-ha-lovelace');
